...
# resnet最基本的结构，self.residual_function相当于F(X)，即残差
...
class ResUNet(nn.Module):
    ...
    def __init__(self,in_channel,out_channel, block, num_block):
        ...
        self.dconv_up3 = unetConv2(256 + 512, 256, True)
        self.dconv_up2 = unetConv2(128 + 256, 128, True)
        self.dconv_up1 = unetConv2(128 + 64, 64, True)
...
def resnet34(in_channel,out_channel,pretrain=True):
    ...
    # if pretrain: model.load_pretrained_weights()
    return model
...
def resnet50():
    ...
    """
    return ResUNet(BottleNeck, [3, 4, 6, 3])


def resnet101():
    """ return a ResNet 101 object
    """
    return ResUNet(BottleNeck, [3, 4, 23, 3])


def resnet152():
    """ return a ResNet 152 object
    """
    return ResUNet(BottleNeck, [3, 8, 36, 3])
